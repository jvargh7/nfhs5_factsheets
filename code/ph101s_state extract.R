...
write.csv(nfhs5_tables,"phase 1 release/NFHS-5 Phase 1 State Factsheets.csv")
write_dta(nfhs5_tables,"phase 1 release/NFHS-5 Phase 1 State Factsheets.dta",version=12)
